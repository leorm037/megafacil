...
final class Version20251226195445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, '
                . 'email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, '
                . 'is_verified TINYINT NOT NULL, nome VARCHAR(60) NOT NULL, created_at DATETIME NOT NULL, '
                . 'updated_at DATETIME DEFAULT NULL, uuid BINARY(16) NOT NULL, '
